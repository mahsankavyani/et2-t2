...
>-> **Elektrische Ladung**<script input="button" onClick="location.href='#7'" style="float:right;">"Zum Kapitel"</script>
...
|<!-- style="background: CadetBlue"--> **Grundgrößen**             |  <!-- style="background: CadetBlue"--> **Einheit**         |
| ----------------------- |------------------|
|   **Länge**               |  <!-- style="background: Lightcyan"--> 1 m (Meter)      |
|   <!-- style="background: Lightcyan"--> **Masse**               |  1 kg (Kilogramm) |
|   **Zeit**                |  <!-- style="background: Lightcyan"--> 1 s (Sekunde)    |
|   <!-- style="background: Lightcyan"--> Elektrische Stromstärke |  1 A (Ampere)     |
|   TemperaturTemperatur    |  <!-- style="background: Lightcyan"--> 1 K (Kelvin)     |
|   <!-- style="background: Lightcyan"--> Stoffmenge              |  1 mol (Mol)      |
|   Lichtstärke             |  <!-- style="background: Lightcyan"--> 1 cd (Candela)   |
...
|  <!-- style="background: CadetBlue"-->   Vorsatz    | <!-- style="background: CadetBlue"--> Zeichen | <!-- style="background: CadetBlue"--> Faktor |
| ---------------|-------- |--------|
| Exa            | E       |10^18^   |
| Peta           | P       |10^15^   |
| Tera           | T       |10^12^   |
...
<!-- style="background-color: Lichtstrategie;"-->
...
![Bild](https://upload.wikimedia.org/wikipedia/commons/c/cc/Schaltung.jpg " Das [Bild](https://commons.wikimedia.org/wiki/File:Schaltung.jpg#/media/File:Schaltung.jpg) ist lizenziert unter [CC0](https://creativecommons.org/publicdomain/zero/1.0/deed.en) ")
